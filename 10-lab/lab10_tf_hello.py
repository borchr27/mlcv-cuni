...
def main(args : argparse.Namespace):
    ...
    model.add(tf.keras.layers.Dense(args.hidden_layer_size, activation=args.activation))
    ...
    # - metrics - (Optional) metric which is reported by the model during training. Let's use MSE.
    model.compile(
    ...
    #   - 'logs' should be a path to the directory with tensorboard logs.
