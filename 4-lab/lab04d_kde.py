...
def main(args : argparse.Namespace) -> None:
    ...
    # TODO: Try to increase the number of points (their order of magnitude) and compare the results.
    ...
    # TODO: Try different values of bandwidth (size of the window - 'h' in lecture, default is 1.0).
